                        ...
                        {navigationItems.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.title}
                                    href={item.url}
                                    className="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-foreground hover:bg-card/60 hover:backdrop-blur-xl hover:shadow-lg hover:shadow-purple-600/10 transition-all duration-300 hover:text-purple-600 hover:scale-[1.02]"
                                >
                                    <div className="p-1.5 rounded-lg bg-gradient-to-br from-muted to-muted/80 group-hover:from-purple-600/20 group-hover:to-purple-700/20 transition-all duration-300 group-hover:shadow-md">
