        ...
        try {
            ...
            container.innerHTML = `
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px;">
                    <div>
                        <h1 style="margin: 0; font-size: 42px; font-weight: 900; color: #10b981; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">SOUNDSAGE</h1>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; opacity: 0.6; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 20px;">
                    <div>
                        <p style="margin: 0; font-size: 11px;">Generated by SoundSage</p>
