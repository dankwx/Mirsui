    ...
    <div className="lp-nav">
      <nav className="nav wrap">
        ...
        <div className="nav-right">
          <a href="Mirsui - Home.html" className="b b-light">Entrar</a>
          <a href="Mirsui - Home.html" className="b b-acc">Criar conta</a>
        </div>
      </nav>
    </div>
  );
    ...
    <header className="hero">
      ...
      <div className="hero-inner wrap">
        ...
        <div className="hero-cta">
          <a href="Mirsui - Home.html" className="b b-acc">Criar conta grátis <I d={IC.arrow} size={16} /></a>
          <a href="Mirsui - Home.html" className="b b-light">Já tenho conta</a>
        </div>
      </div>
      <Ticker />
    </header>
...
function EndCTA() {
  return (
    <section className="endcta wrap">
      ...
      <div><a href="Mirsui - Home.html" className="b b-acc">Criar conta grátis <I d={IC.arrow} size={16} /></a></div>
